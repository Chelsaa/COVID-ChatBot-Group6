...
int hospital_1()
{
 ...
 cont:   
    ...
    case 1:
        ...
        break;
    case 2:
        printf("Ans. \n- No, if it's neccessary the hospital will do the test");
        printf("\n\nAny more queries?(y/n) : ");
        scanf(" %c", &boolean);
        if (boolean == 'y')
        {
        ...
        break;
    case 3:
        printf("Ans. \n- No, we don't want the virus to spread any more");
        printf("\n\nAny more queries?(y/n) : ");
        scanf(" %c", &boolean);
        if (boolean == 'y')
        {
    ...
    case 4:
        ...
        break;
    case 5:
        printf("Ans. \n- Hospitals comply with all guidelines established by the government");
        printf("\n\nAny more queries?(y/n) : ");
        scanf(" %c", &boolean);
        if (boolean == 'y')
        {
        ...
        break;
    case 6:
        printf("Ans. \n- No, just pattients with covid 19 ");
        printf("\n\nAny more queries?(y/n) : ");
        scanf(" %c", &boolean);
        if (boolean == 'y')
        {
        ...
        break;
    case 7:
        printf("Ans. \n- Yes, some hospitals are vaccinating during normal business hours");
        printf("\n\nAny more queries?(y/n) : ");
        scanf(" %c", &boolean);
        if (boolean == 'y')
        {
        ...
        break;
    case 8:
        printf("Ans. \n- They can be done by phone or through the website");
        printf("\n\nAny more queries?(y/n) : ");
        scanf(" %c", &boolean);
        if (boolean == 'y')
        {
        ...
        break;
    case 9:
        printf("Ans. \n- Yes, they provide medications, but they are limited");
        printf("\n\nAny more queries?(y/n) : ");
        scanf(" %c", &boolean);
        if (boolean == 'y')
        {
        ...
        break;
    case 10:
        printf("Ans. \n- Yes, for specialty consultations it is necessary to schedule an appointment, however it is not necessary in the emergency room");
        printf("\n\nAny more queries?(y/n) : ");
        scanf(" %c", &boolean);
        if (boolean == 'y')
        {
